...
`;
  ...
  window.monaco.editor.defineTheme('myCustomTheme', themeData)
  window.monaco.editor.setTheme('myCustomTheme')

  window.monaco.editor.onDidCreateModel((model) => {
    console.log("Editor model created", model.TextModel);
    window.monaco.editor.defineTheme('myCustomTheme', themeData)
    setTimeout(() => {
      window.monaco.editor.setTheme('myCustomTheme');
    }, 200); 
  });
  window.monaco.editor.onWillDisposeModel((model) => {
    console.log("Editor model onWillDisposeModel", model);
    window.monaco.editor.defineTheme('myCustomTheme', themeData)
    window.monaco.editor.setTheme('myCustomTheme')
  });
}
